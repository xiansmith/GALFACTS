...
/**********************************************************************/
void fluxwappdata_readchan_binary0(const char *field, FluxWappData * wappdata, int chan, int id, int avg, float decmin, float decmax)
{
...
s += s += fwrite(&pRec->stokes.Q, sizeof(float), 1, file);
