...
int *idvector(long nl, long nh);
unsigned char *cdvector(long nl, long nh);
unsigned long *ldvector(long nl, long nh);
double *ddvector(long nl, long nh);
double **dmatrix(long nrl, long nrh, long ncl, long nch);
double **ddmatrix(long nrl, long nrh, long ncl, long nch);
int **idmatrix(long nrl, long nrh, long ncl, long nch);
...
void free_idvector(int *v, long nl, long nh);
void free_cdvector(unsigned char *v, long nl, long nh);
void free_ldvector(unsigned long *v, long nl, long nh);
void free_ddvector(double *v, long nl, long nh);
void free_dmatrix(double **m, long nrl, long nrh, long ncl, long nch);
void free_ddmatrix(double **m, long nrl, long nrh, long ncl, long nch);
void free_idmatrix(int **m, long nrl, long nrh, long ncl, long nch);
