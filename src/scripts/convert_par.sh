...
date
dir_use=$PWD
array=(`ls -d 5*/`) #need to ensure no other directories.
echo ${array[*]}  
#echo ${array[*]}  >> "logfile"
len=${#array[*]}
...
jobnumber=0
ddmmyy=(`date`)
#echo ${ddmmyy[*]} | mail -s "Started conversion jobs..." gurm.sukhpreet@gmail.com
...
ddmmyy=(`date`)
echo ${ddmmyy[*]} | mail -s "Processed all of the MOCK band0 conversion..." gurm.sukhpreet@gmail.com
